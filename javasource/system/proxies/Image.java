...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MicrosoftGraph.ProfilePhoto", mendixObject.getType())) {
			return microsoftgraph.proxies.ProfilePhoto.initialize(context, mendixObject);
		}
